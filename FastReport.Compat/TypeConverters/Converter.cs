...
namespace FastReport.Utils
{
  ...
  public static class Converter
  {
    ...
    public static string ToString(object value)
    {
      ...
      if (value is Type)
      {
        ...
        return type.AssemblyQualifiedName;
            ...
            if (value is Font)
            {
                return FontConverter.Instance.ConvertToInvariantString(value);
            }
#endif
    ...
    public static object FromString(Type type, string value)
    {
      ...
      if (type == typeof(string[]))
      {
        ...
        return value.Split(new char[] { '\r' });
            ...
            if (type == typeof(Font))
            {
                return FontConverter.Instance.ConvertFromInvariantString(value);
            }
#endif
    ...
    /// <param name="text">String for processing</param>
    /// <param name="position">Position for processing</param>
    /// <param name="result">Append result of processing to StringBuilder</param>
    /// <returns>True if successful</returns>
